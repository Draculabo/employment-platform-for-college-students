...
<template>
  ...
  <div class="introduce flex flex-space-around flex-align-center">
    ...
    <div class="introduce-r tac" data-aos="fade-left">
      <h2>一个旨在为<span class="highlight">大学生</span>服务的<span class="highlight">就业</span>平台</h2>
    </div>
  </div>
  <div class="mask" />
  <div class="introduce white-bg flex flex-space-around flex-align-center">
    ...
    <div class="ball-bottom" data-aos="fade-right" data-aos-duration="1000" />
    <div class="ball-top" data-aos="fade-up" data-aos-duration="1000" />
  </div>
