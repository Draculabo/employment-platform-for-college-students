export const RedisKey = {
  ...
  agoraRTCRoomUserToken: (roomUUID: string, uid: string | number): string => `agora:rtc:room:${roomUUID}:uid:${uid}`,
  agoraRTMUserToken: (userUUID: string): string => `agora:rtm:userUUID:${userUUID}`,
  cloudStorageFileInfo: (userUUID: string, fileUUID: string): string => `cloudStorage:${userUUID}:${fileUUID}`,
  userAvatarFileInfo: (userUUID: string, fileUUID: string): string => `user:avatar:${userUUID}:${fileUUID}`,
  ...
  oauthLogoFileInfo: (oauthUUID: string, fileUUID: string): string => `oauth:logo:${oauthUUID}:${fileUUID}`,
  ...
  oauthAuthorizeCSRFToken: (oauthUUID: string, userUUID: string): string => `oauth:authorize:csrfToken:${oauthUUID}:${userUUID}`,
  oauthAuthorizeScopes: (oauthUUID: string, userUUID: string): string => `oauth:authorize:scopes:${oauthUUID}:${userUUID}`,
  oauthAuthorizeAccessToken: (accessToken: string): string => `oauth:authorize:accessToken:${accessToken}`,
  oauthAuthorizeRefreshToken: (refreshToken: string): string => `oauth:authorize:refreshToken:${refreshToken}`,
  oauthAuthorizeTokenByUserUUID: (clientID: string, userUUID: string) => `oauth:authorize:clientID:${clientID}:user:${userUUID}`,
};
