...
export class DeveloperOAuthService {
  ...
  public async create(config: DeveloperOAuthCreateConfig): Promise<string> {
    const oauthInfoSVC = new DeveloperOAuthInfoService(this.ids, this.DBTransaction, this.userUUID);
  ...
  public async listByUser(config: DeveloperOAuthListByUserConfig): Promise<DeveloperOAuthListByUserReturn> {
  ...
  public async info(oauthUUID: string): Promise<DeveloperOAuthInfoReturn> {
    const oauthInfosSVC = new DeveloperOAuthInfoService(this.ids, this.DBTransaction, this.userUUID);

    const oauthSecretSVC = new DeveloperOAuthSecretService(this.ids, this.DBTransaction, this.userUUID);

    const oauthUserSVC = new DeveloperOAuthUserService(this.ids, this.DBTransaction, this.userUUID);
  ...
  public async delete(oauthUUID: string): Promise<void> {
    ...
    await Promise.all([oauthInfosSVC.delete(oauthUUID), oauthSecretSVC.deleteAll(oauthUUID), oauthUserSVC.deleteByOAuthUUID(oauthUUID)]);
  }
}
