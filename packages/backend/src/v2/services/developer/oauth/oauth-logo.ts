...
export class DeveloperOAuthLogoService {
  ...
  public async start(config: DeveloperOAuthLogoStartConfig): Promise<DeveloperOAuthLogoStartReturn> {
    ...
    const ossFilePath = DeveloperOAuthLogoService.generateOSSFilePath(fileName, config.oauthUUID, fileUUID);
  ...
  public async finish(config: DeveloperOAuthLogoFinishConfig): Promise<void> {
    ...
    const developerOAuthInfoSVC = new DeveloperOAuthInfoService(this.ids, this.DBTransaction, this.userUUID);
  ...
  public async getFileInfoByRedis(oauthUUID: string, fileUUID: string): Promise<GetDeveloperOAuthLogoByRedisReturn> {
  ...
  public static generateOSSFilePath = (fileName: string, oauthUUID: string, fileUUID: string): string => {
