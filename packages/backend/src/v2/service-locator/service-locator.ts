import { ServicesCreatorCatalog, ServiceID, ServicesCatalog, ServicesPendingCatalog, ServicesCatalogParams } from './catalog';
...
export class ServiceLocator {
  ...
  public getOnceService<T extends ServiceID>(name: T, params: ServicesCatalogParams[T]): ServicesCatalog[T] {
    const creator = this.registry[name];
    if (creator) {
